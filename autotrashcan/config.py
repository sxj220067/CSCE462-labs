...
STEP_MOVE_ENABLED = True
STEP_MOVE_DURATION_S = 0.18
STEP_SETTLE_MIN_S = 0.20
STEP_SETTLE_MAX_S = 1.20
CAMERA_STILL_DIFF_THRESHOLD = 7.0
CAMERA_STILL_CONSECUTIVE_FRAMES = 4
MOTOR_MOCK = False
MOTOR_DRIVER = "l298n"
