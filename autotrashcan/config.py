...
OBJECT_DETECT_EVERY_N_FRAMES = 1
...
SELF_LEARNING_RATE = 0.08
SELF_LEARNING_UPDATE_INTERVAL_S = 0.25
SELF_LEARNING_MIN_ERROR_PX = 12
SELF_LEARNING_MAX_X_BIAS_PX = 140
SELF_LEARNING_MAX_Y_BIAS_PX = 140
SELF_LEARNING_SAVE_PATH = "autotrashcan/learned_alignment.json"
MOTOR_MOCK = False
MOTOR_DRIVER = "l298n"
...
MOTOR_FORWARD_DUTY = 0.75
MOTOR_REVERSE_DUTY = 0.75
MOTOR_TURN_DUTY = 0.65
